...
print("<br>1 = Erros de julgamento do motorista")
print("<br>2 = Velocidade / comportamento arriscado")
print("<br>3 = Falhas mecânicas")
print("<br>4 = Condições da estrada / ambientais")
print("<br>5 = Distrações")
print("<br>6 = Uso de Substâncias")  
print("<br>7 = Fatores diversos" )
print("<br>8 = Outros")
